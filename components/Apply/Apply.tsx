              ...
              <form action="#">
                <div className="form-group">
                  ...
                  <small className="form-text mt-2">
                    Enter the name of your game project
                  </small>
                </div>
                <div className="form-group">
                  ...
                  <small className="form-text mt-2">
                    Tell us about your game project in a few sentences: genre,
                    idea, concept
                  </small>
                </div>
                <div className="form-group">
                  ...
                  <small className="form-text mt-2">
                    Describe the stage your project is at
                  </small>
                </div>
                <div className="form-group">
                  ...
                  <small className="form-text mt-2">
                    Enter the amount you need to deliver your game (e.g. $100k)
                  </small>
                </div>
                <div className="form-group">
                  <label htmlFor="description">
                    Describe your game assets you are going to pre-sell as NFTs
                  </label>
                  <textarea
                    id="description"
                  ...
                  />
                  <small className="form-text mt-2">
                    Briefly describe your assets. E.g. X units of spaceships
                  </small>
                </div>
                <div className="form-group">
                  ...
                  <small className="form-text mt-2">
                    Add a game demo video, or a link to screenshots or artworks
                  </small>
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <small className="form-text mt-2">
                    We may contact you on Telegram
                  </small>
                </div>
